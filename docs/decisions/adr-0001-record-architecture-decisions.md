...
> _Mirrored from the [Microbot](https://github.com/chsami/microbot) repository as reference material. Some links point to files that live in the main Microbot repo._
